  ...
  return (
    ...
    <div className="footer-social-links">
      <div className="subs">
        ...
        <span>
          <input type="text" placeholder="Your email address" className="subscribe-inp" />
      ...
      <div className="social-media-images">
        ...
        <div class="footer_socialMedia-links">
          <a href="link" ><img src={facebookImage} className="social-image" id="social-facebook" alt="fb" /></a>
          <a href="link" ><img src={tweeterImage} className="social-image" id="social-twitter" alt="tw" /></a>
          <a href="link" ><img src={instagramImage} className="social-image" id="social-instagram" alt="ig" /></a>
          <a href="link" ><img src={youtubeImage} className="social-image" id="social-youtube" alt="yt" /></a>
        </div>
      </div>
    </div>
  );
