...
export function CarouselFeaturedSets() {
  useEffect(() => {
    ...
    let slides = carousel.querySelectorAll(".product-container2");
    let transparentClass = document.querySelectorAll(".transparent-container2");
    let firstImg = carousel.querySelectorAll(".product-container2")[0];
    let arrowIcons = document.querySelectorAll(".wrapper2 i");
    let runnerBar = document.querySelector("#runnerBar2");
    let runnerBarContainer = document.querySelector("#runnerBarCont2");
  ...
  return (
    <div className="ml-[7vw] font-[Cerapro,sans-serif]">

      <label for="featured-sets-wholebody-container" class="featured-sets">Featured sets</label>
      <div class="wrapper2">
        <div class="featured-sets-wholebody-container carousel2" aria-labelledby="featured-sets" >
          ...
          <section class="product-container2" aria-labelledby="featured-sets">
            <div class="transparent-container2">
              <div class="add-wish-list">
                <div class="svg-container">
                  <svg width="30" height="30" viewBox="0 0 40 40" alt="" class="WishlistButtonstyles__StyledWishlistIcon-sc-1iowmvt-1 biMOpX">
      ...
      <div id="runnerBarCont2">
        <div id="runnerBar2"></div>
      </div>
